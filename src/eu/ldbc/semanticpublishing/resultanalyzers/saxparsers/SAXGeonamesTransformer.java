 ...
 */
public class SAXGeonamesTransformer extends DefaultHandler implements SAXResultTransformer {
	...
	private ArrayList<String> geonamesIdsList; 
	
	@Override
	public void startDocument() throws SAXException {
		geonamesIdsList = new ArrayList<String>();
	}
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		if(wasInResultElement) {
			...
			geonamesIdsList.add(uriSb.toString());
		}
	}
