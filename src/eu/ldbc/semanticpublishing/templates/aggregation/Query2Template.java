 ...
 */
public class Query2Template extends MustacheTemplate implements QueryParametersGenerator {
	...
	public Query2Template(RandomUtil ru, HashMap<String, String> queryTemplates, int seedYear, String[] substitutionParameters) {
