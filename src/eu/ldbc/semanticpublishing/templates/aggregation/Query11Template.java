 ...
 */
public class Query11Template extends MustacheTemplate implements QueryParametersGenerator {
	...
	public Query11Template(RandomUtil ru, HashMap<String, String> queryTemplates, int seedYear, String[] substitutionParameters) {
